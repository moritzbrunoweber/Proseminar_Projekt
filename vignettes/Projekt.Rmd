...
The first part of data processing concerns the change in tree cover. From the downloaded .hdf files, which include multiple layers with vegetation related data, the layers containing the tree cover data need to be extracted, mosaiced together and then masked with the area of interest. 
