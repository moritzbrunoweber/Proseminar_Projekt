...
plot(max_trend_aoi,
     main = "Trend der jährlichen Maxima (Steigung/Jahr)",
     col = cols_max$col,
...
plot(min_trend_aoi,
     main = "Trend der jährlichen Minima (Steigung/Jahr)",
     col = cols_min$col,
     range = cols_min$range)
plot(st_geometry(polygon_sf), add = TRUE, border = "red", lwd = 2)

png(here::here("fig", "max_trend_tws.png"), width=2000, height=1500, res=300)
plot(max_trend_aoi,
     main = "Trend der jährlichen TWS Maxima",
     col = cols_max$col,
     range = cols_max$range)
plot(st_geometry(polygon_sf), add = TRUE, border = "red", lwd = 2)
dev.off()

png(here::here("fig", "min_trend_tws.png"), width=2000, height=1500, res=300)
plot(min_trend_aoi,
     main = "Trend der jährlichen TWS Minima",
     col = cols_min$col,
     range = cols_min$range)
plot(st_geometry(polygon_sf), add = TRUE, border = "red", lwd = 2)
dev.off()

png(here::here("fig", "trend_tws.png"), width=2000, height=1500, res=300)
plot(trend_aoi,
     main = "Yearly Trend in change of TWS Amplitude",
     col = cols_trend$col,
     range = cols_trend$range)
plot(st_geometry(polygon_sf), add = TRUE, border = "red", lwd = 2)
dev.off()
