...
png(
  filename = here::here("fig", "trend_tws.png"),
  width = 2000,
  height = 1500,
  res = 300
)
...
plot(max_trend_aoi, main = "Trend der jährlichen Maxima", col = viridis::viridis(100))
plot(min_trend_aoi, main = "Trend der jährlichen Minima", col = viridis::viridis(100))
```
