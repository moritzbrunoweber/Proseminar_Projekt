...
```
```{r}
# lineare Regression für jeden Pixel der Zeitreihe >> stimmt Regressionskoeffizient mit change in treecover überein?
...
plot(vals[, "tree"], vals[, "trend"],
     xlab = "Tree cover change (2002–2024)",
     ylab = "TWS amplitude trend (per year)",
